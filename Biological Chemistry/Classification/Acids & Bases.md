...
Water molecules and hydroxide ions interchange.

## Conjugated Acids & Bases

Every acid has a **conjugated base**, every base has a **conjugated acid**.
Strong acid/base → weak conjugated base/acid (and vice versa).
...
$K_a = \frac{\ce{[H+][A-]}}{\ce{[HA]}} \text{ for an acid } \ce{HA} \text{ in water}$
...
$K_{eq} = \frac{\ce{[H+][A-]}}{\ce{[HA][H2O]}} = \frac{K_a}{\ce{[H2O]}}$
