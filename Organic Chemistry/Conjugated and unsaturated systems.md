...
$e^-$ can move throughout the molecule's structure.
This stabilizes the structure, especially when an additional charge is present.

Rules for drawing resonance structures:
1. The real structure is the weighed average of the resonance structures.
2. **Only** $e^-$ move through the structure. All the atoms stay where they were.
3. **No hypervalent 2nd row elements!**
...
The $\pi$-system of **ethene**:
![[_media/Conjugated and unsaturated systems/canjutation-ethene-pi-system.png]]

**HOMO** - Highest Occupied Molecular Orbital.
**LUMO** - Lowest Unoccupied Molecular Orbital.

In ethene, HOMO is the $\pi$ bonding orbital (ethene has a $\pi$ bond), and LUMO is the $\pi^*$ anti-bonding orbital.

MO Theory is crucial for understanding conjugation.
...
[Reaction intermediates](Reaction%20intermediates) created from conjugated systems have resonance:
![[_media/Conjugated and unsaturated systems/conjugation-intermediates.png]]

## In reactions

#### Rearrangement

Since conjugated systems can form resonance structures, they will sometimes rearrange to become more stable as reaction intermediates.

![[_media/Conjugated and unsaturated systems/conjugation-rearrangement.png]]

The proportions of the formed products depend on the temperature:
- Low temperature → kinetic product (formed faster, no rearrangement).
- High temperature → thermodynamic product (more stable, rearrangement).

![[_media/Conjugated and unsaturated systems/conjugation-temperature.png]]
